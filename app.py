...
if st.button('Recommend'):
    recommended_movies, recommended_posters = recommend(selected_movie_name, top_n=num_recommendations)
    
    cols = st.columns(num_recommendations)  # Create dynamic columns
